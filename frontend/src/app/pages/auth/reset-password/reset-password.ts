...
@Component({
  ...
  styles: [`
    ...
    .field input { width:100%;padding:12px 15px;border-radius:14px;background:#e0f6f9;border:1px solid rgba(0,180,198,.16);color:#1a2d3a;font-size:14px;font-family:inherit;outline:none;transition:all .25s cubic-bezier(.16,1,.3,1);box-sizing:border-box; }
