...
@Component({
  ...
  styles: [`
    ...
    .field input { padding:12px 15px;border-radius:14px;background:#f8f1fc;border:1px solid rgba(167,139,250,.16);color:#221f2c;font-size:14px;font-family:inherit;outline:none;transition:all .25s cubic-bezier(.16,1,.3,1); }
    ...
    .link { font-size:13px;color:#a78bfa;text-decoration:none;font-weight:700; }
