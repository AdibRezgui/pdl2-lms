...
export const routes: Routes = [
  ...
  // Student
  {
    ...
    children: [
      ...
      { path: 'parcours',    loadComponent: () => import('./pages/student/parcours/parcours').then(m => m.StudentParcours) },
      { path: 'learn/:courseId', loadComponent: () => import('./pages/student/learn/learn').then(m => m.StudentLearn) },
  ...
  // Trainer
  {
    ...
    children: [
      ...
      { path: 'courses/:courseId/content', loadComponent: () => import('./pages/trainer/course-content/course-content').then(m => m.TrainerCourseContent) },
      ...
      { path: 'evaluations', redirectTo: 'courses', pathMatch: 'full' },
      { path: 'profile',     loadComponent: () => import('./pages/shared/profile/profile').then(m => m.ProfilePage) },
    ],
  },
